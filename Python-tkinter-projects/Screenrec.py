...
image1 = PhotoImage(file="D:\Sriram\Python projects\Python-tkinter-projects\Images\yelllow1.png")
Label(root, image=image1, bg="#969696").place(x=-2, y=20)
image =  PhotoImage(file=r"D:\Sriram\Python projects\Python-tkinter-projects\Images\blue.png")
